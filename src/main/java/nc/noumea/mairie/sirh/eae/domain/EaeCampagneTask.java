...
@NamedQueries({
	@NamedQuery(
			name = "EaeCampagneTask.getNextEaeCampagneTask", 
			query = "select e from EaeCampagneTask e where e.dateCalculEae is NULL AND e.taskStatus is NULL order by e.idEaeCampagneTask asc"
			)
})
